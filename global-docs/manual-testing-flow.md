...
Panduan pengujian manual langkah-demi-langkah ini mencakup seluruh alur pengguna (*End-to-End User Flows*), parameter pengujian, kondisi penerimaan (*Acceptance Criteria*), serta analisis skenario batas (*Edge Cases*) untuk protokol **OMEN V1 Social Belief Market** sesuai spesifikasi `global-docs/update-brief-1.md`.

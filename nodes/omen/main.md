# AI Orchestrator: Master Entrypoint — Omen

> 🟢 **STATUS MODE SAAT INI:** MODE 1 (Autonomous Planning)
...
> Node ini terisolasi! Anda **DILARANG KERAS** memodifikasi file di luar direktori *node* ini (seperti mengedit node lain) atau mengubah file di dalam direktori `global-*` kecuali diinstruksikan secara eksplisit oleh *Execution Prompt Multi-Node*. Fokuslah hanya pada *path* lokal di dalam node ini dan codebase terkait di `/Users/raka/Developer/repositories/projects/wealthy-people-org/omen-dir/omen`.
...
2. `docs/system-design.md` (Arsitektur teknis spesifik node Omen)
3. `../../global-docs/design-system.md` (Aturan UI/UX, warna, tipografi global)
4. `docs/development-planning.md` (Peta jalan spesifik node Omen)
...
3. `guidelines/project-context.md` (Aturan khusus & hasil pemindaian sistem dari node Omen)
...
Sebelum melakukan pemindaian manual atau pengerjaan instruksi, Anda **WAJIB** mengecek apakah terdapat direktori `.graphify` di dalam *Path Codebase* (`/Users/raka/Developer/repositories/projects/wealthy-people-org/omen-dir/omen`) dari node ini.
